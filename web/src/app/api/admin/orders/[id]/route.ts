...
// Access is enforced by proxy.ts, which guards /api/admin/:path* — same as the
// other admin routes. The session is re-read here only to attribute the change
// to an admin, not to authorise it.
